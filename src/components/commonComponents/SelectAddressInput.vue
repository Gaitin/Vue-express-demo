      ...
      <div class="AddressSelect">
        <mu-bottom-sheet :open="AddressBottomSheet" @close="closeAddressBottomSheet">
          <div class="demo-picker-container">
            <div class="BSHeader">
              <a href="javascript:;" @click="closeAddressBottomSheet">取消</a>
              <a href="javascript:;" @click="closeAddressBottomSheet">确定</a>
            </div>
...
<script>
  const address = {
    '北京': ['朝阳区','昌平区','海淀区','顺义区','东城区','西城区','大兴区','通州区','房山区','密云区','门头沟区'],
              ...
              addressSlots: [
                {
                  ...
                  width: '100%',
                  textAlign: 'left',
                  values: ['朝阳区','昌平区','海淀区','顺义区','东城区','西城区','大兴区','通州区','房山区','密云区','门头沟区']
                }
              ],
              address: ['北京', '朝阳区'],
